...
**Features**
- 🎰 **Real casino games:** Blackjack (6 decks, 3:2, split, double, insurance), Texas Hold'em against bots and other players, Ultimate Texas Hold'em against the dealer, Punto Banco baccarat (Player, Banker, Tie and pair bets) and player-banked Chemin de fer, three themed 5×3 243-ways video slots (Overworld Riches, Nether Inferno and End Void) with their own bonus games (Treasure Hunt, Piglin's Hoard, Dragon Wheel) and Mini / Minor / Major / Grand jackpots, European roulette with every standard bet, and full craps (pass/don't pass, come, field, odds).
- 🎲 **Side games:** Coin Flip, Wheel of Fortune, Scratch Cards, Plinko and Dice Duels.
- ⚔️ **PvP modes:** Coin Flip Duel, Wheel Party, Plinko Battle, Scratch Showdown and Slot Showdown. Players bet against each other for a pot; the house only takes a small cut.
- 🤖 **Seats & Bots:** every table and PvP match can be humans only, bots only or mixed, with Easy, Normal and Hard bots, each with its own nameplate above its seat.
- 🎬 **Animated screens:** redesigned screens with dealt cards, sliding chips and spinning reels, themed to the village casino, the Piglin Parlor or the End.
...
- 🏆 **65 advancements** in their own tab.
