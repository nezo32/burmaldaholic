...
const ALLOWED: Record<string, string> = {
  ...
  'core/wagers.ts:runInterval': 'keeps already-lost temporary heart penalties applied (no new effect)',
  ...
  'games/slots/index.ts:playerLeave': 'settles a spin already in flight (§4.1)',
