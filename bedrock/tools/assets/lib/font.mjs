// Glyph sheets (docs/architecture/animation.md §2.2, §6): Bedrock `font/glyph_XX.png` pages are 16 × 16 cells,
// the glyph for U+XXRC sits in row R, column C. Java uses the SAME PNG through a `bitmap` font provider
