...
// toast, contract stamp; Bedrock JSON UI textures. Pure drawing: returns images, core.mjs names the files.
...
/** Bedrock trophy icon 16² (achievement toast). */
export function trophy() {
  return drawGrid(
    ...
    { Y: 'gold', w: '#FFF3A0', o: 'gold.shade' },
  );
}

/** Bedrock HUD bell flipbook 8 × 16 (2 frames: rest / swung) for the loan-default swing. */
export function bell(frameIdx) {
  const rows = frameIdx === 0
    ? ['...R....', '..RRR...', '.RRrRR..', '.RRrRR..', '.RRRRR..', 'RRRRRRR.', '...D....', '........']
    : ['....R...', '...RRR..', '..RrRRR.', '.RRrRRR.', '.RRRRRR.', 'RRRRRRR.', '....D...', '........'];
  return drawGrid(image(8, 8), rows, { R: 'chip.red', r: 'chip.light', D: 'chip.dark' });
}
